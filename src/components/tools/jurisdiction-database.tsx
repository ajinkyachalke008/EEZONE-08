...
export function JurisdictionDatabase() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Jurisdiction Database</CardTitle>
          <CardDescription>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2">
                        {jurisdiction.permitRequired ? (
                          <Badge className="bg-green-100 text-green-800 text-xs">Permit Required</Badge>
                        ) : (
                          <Badge className="bg-gray-100 text-gray-800 text-xs">No Permit</Badge>
                        )}
                        {jurisdiction.inspectionRequired && (
                          <Badge className="bg-blue-100 text-blue-800 text-xs">Inspection Required</Badge>
                        )}
                      </div>
          ...
          {selectedJurisdiction && (
            <Card className="border-2 border-[#00C2D1]">
              <CardHeader>
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <CardTitle className="text-2xl">{selectedJurisdiction.name}</CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                  <div>
                    <Label className="text-sm text-gray-600">NEC Version</Label>
                    <p className="font-semibold">NEC {selectedJurisdiction.necVersion}</p>
                  </div>
                  <div>
                    <Label className="text-sm text-gray-600">License Required</Label>
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-lg flex items-center gap-2">
                    <Phone className="h-5 w-5 text-[#00C2D1]" />
                    Contact Information
                  </h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <Phone className="h-4 w-4 text-gray-500" />
                      <a href={`tel:${selectedJurisdiction.contactPhone}`} className="text-blue-600 hover:underline">
                  ...
                  <div className="space-y-2">
                    {selectedJurisdiction.amendments.map((amendment, idx) => (
                      <div key={idx} className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <p className="text-sm text-gray-700">{amendment}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700">{selectedJurisdiction.notes}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <Card className="bg-gradient-to-br from-[#071428] to-[#0a1d38] text-white">
                  <CardContent className="pt-6">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-[#00C2D1]">
                          {selectedJurisdiction.permitRequired ? 'YES' : 'NO'}
                        </div>
                        <div className="text-sm opacity-80">Permit Required</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-[#00C2D1]">
                          {selectedJurisdiction.inspectionRequired ? 'YES' : 'NO'}
                        </div>
                        <div className="text-sm opacity-80">Inspection Required</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-[#00C2D1]">
                          {selectedJurisdiction.electricianLicenseRequired ? 'YES' : 'NO'}
                        </div>
                        <div className="text-sm opacity-80">License Required</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          {!searchQuery && !selectedJurisdiction && (
            <Card className="bg-gradient-to-br from-[#071428] to-[#0a1d38] text-white">
              <CardContent className="py-12">
                <MapPin className="h-16 w-16 text-[#00C2D1] mx-auto mb-4" />
