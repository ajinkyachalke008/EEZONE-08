...
const certifications = [
  ...
  },
  {
    ...
    icon: Briefcase,
    color: 'orange',
    features: ['Project lifecycle', 'Agile methodologies', 'Risk management', 'PMI standards'],
  },
  {
    id: 'cem',
    title: 'Certified Energy Manager',
    description: 'Energy efficiency and management certification',
    level: 'Professional',
    duration: '6-8 weeks',
    questions: 60,
    icon: Zap,
    color: 'cyan',
    features: ['Energy auditing', 'HVAC systems', 'Renewable energy', 'Cost analysis'],
  },
  {
    id: 'leed',
    title: 'LEED AP BD+C',
    description: 'Green building design certification',
    level: 'Professional',
    duration: '4-6 weeks',
    questions: 100,
    icon: Target,
    color: 'violet',
    features: ['Sustainable design', 'Building systems', 'Energy modeling', 'LEED credits'],
  },
  {
    id: 'nicet',
    title: 'NICET Level III',
    description: 'Fire alarm systems certification',
    level: 'Advanced',
    duration: '12-16 weeks',
    questions: 120,
    icon: Award,
    color: 'orange',
    features: ['System design', 'Code compliance', 'Installation standards', 'Testing procedures'],
  },
  {
    id: 'autocad',
    title: 'AutoCAD Certified',
    description: 'Professional CAD design certification',
    level: 'Intermediate',
    duration: '4-6 weeks',
    questions: 50,
    icon: GraduationCap,
    color: 'cyan',
    features: ['2D/3D drawing', 'Electrical symbols', 'Layout design', 'Best practices'],
  },
  {
    id: 'six-sigma',
    title: 'Six Sigma Green Belt',
    description: 'Process improvement certification',
    level: 'Intermediate',
    duration: '6-8 weeks',
    questions: 100,
    icon: Target,
    color: 'violet',
    features: ['DMAIC methodology', 'Statistical tools', 'Quality control', 'Lean principles'],
  },
  {
    id: 'comptia',
    title: 'CompTIA A+ Core',
    ...
    icon: GraduationCap,
    color: 'orange',
    features: ['Hardware basics', 'Networking', 'Troubleshooting', 'Security fundamentals'],
  },
  {
    id: 'nfpa',
    title: 'NFPA 70E Certified',
    ...
    icon: Award,
    color: 'cyan',
    features: ['Arc flash safety', 'PPE requirements', 'Risk assessment', 'Safe work practices'],
  },
];
